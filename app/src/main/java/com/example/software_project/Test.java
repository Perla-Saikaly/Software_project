...
/*
        ...
        NewBookFragment newBook = new NewBookFragment();
        ...
        btnNewBooks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                fragmentManager.beginTransaction()
                        .replace(R.id.fragmentContainerView, NewBookFragment.class, null)
        ...
        btnUsedBooks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                fragmentManager.beginTransaction()
                        .replace(R.id.fragmentContainerView, UsedBookFragment.class, null)
                        .setReorderingAllowed(true)
                        .addToBackStack(null)
                        .commit();
            }
